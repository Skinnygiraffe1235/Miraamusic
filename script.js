...
function updateBrand(target) {
  ...
  if (brandWordmark) {
    brandWordmark.setAttribute('aria-label', isTechnician ? 'Mahdi Tajoby home' : 'Miraamusic home');
  ...
  if (brandEyebrow) brandEyebrow.textContent = isTechnician ? 'Audio Engineer / Music Technologist' : 'Musician / Live Performer';
}
